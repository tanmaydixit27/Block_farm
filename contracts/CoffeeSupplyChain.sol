...
contract CoffeeSupplyChain is Ownable {
    ...
    modifier isValidPerformer(address batchNo, string role) {
        require(
            keccak256(supplyChainStorage.getUserRole(msg.sender)) ==
                keccak256(role)
        );
        require(
            keccak256(supplyChainStorage.getNextAction(batchNo)) ==
                keccak256(role)
        );
        _;
    }
    ...
    {
        /* Call Storage Contract */
        (coffeeFamily, typeOfSeed, fertilizerUsed) = supplyChainStorage
            .getFarmInspectorData(_batchNo);
    ...
    {
        /* Call Storage Contract */
        (cropVariety, temperatureUsed, humidity) = supplyChainStorage
            .getHarvesterData(_batchNo);
        ...
        )
    {
        ...
        (
            ...
            estimateDateTime,
            exporterId
        ) = supplyChainStorage.getExporterData(_batchNo);
        ...
        )
    {
        ...
        (
            ...
            warehouseAddress,
            importerId
        ) = supplyChainStorage.getImporterData(_batchNo);
        ...
        )
    {
        ...
        (
            ...
            processorName,
            processorAddress
        ) = supplyChainStorage.getProcessorData(_batchNo);
